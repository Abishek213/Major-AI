...
You can message organizers directly through the event page messaging system.`;
    ...
    logger.info("Created default FAQ file");
  }
    ...
    return [
      {
        ...
        answer:
          "Select your event, choose tickets, and complete payment through our secure checkout.",
        category: "booking",
      },
      {
        question: "Can I get a refund?",
        answer:
          "Refunds are available up to 48 hours before the event. Contact support for assistance.",
        category: "refund",
      },
      {
        question: "How do event recommendations work?",
        answer:
          "Our AI analyzes your interests and past bookings to suggest relevant events.",
        category: "recommendations",
      },
    ];
  }

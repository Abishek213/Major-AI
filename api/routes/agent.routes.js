...
// ==================== Planning ROUTES ===========================
// POST /api/agents/organizer/plan-event (Legacy – now uses real Planning Agent)
router.post("/organizer/plan-event", agentController.planEvent);
// POST /api/agents/organizer/planning/suggest
router.post(
  "/organizer/planning/suggest",
  agentController.getPlanningSuggestions
);
